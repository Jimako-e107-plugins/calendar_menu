...
$CALENDAR_TEMPLATE['calendar']['time_table_start']         = "";
$CALENDAR_TEMPLATE['calendar']['time_table_end']  = "";
...
$CALENDAR_WRAPPER['calendar']['EC_PREV_MONTH'] =  "<span class='defaulttext'>{---}</span>";
$CALENDAR_WRAPPER['calendar']['EC_CURRENT_MONTH'] =  "<b>{---}</b>";
$CALENDAR_WRAPPER['calendar']['EC_NEXT_MONTH'] =  "<span class='defaulttext'>{---}</span>";
$CALENDAR_WRAPPER['calendar']['EC_PREV_YEAR'] =  "{---}";
$CALENDAR_WRAPPER['calendar']['EC_MONTH_LIST'] =  "{---}";
$CALENDAR_WRAPPER['calendar']['EC_NEXT_YEAR'] =  "{---}";
...
//$CALENDAR_WRAPPER['calendar']['EC_NAV_LINKCURRENTMONTH'] =  "<span class='btn button' style='width:120px; '>{---}</span>";

$CALENDAR_WRAPPER['calendar']['EC_NAV_LINKCURRENTMONTH'] =  "{---}";
...
$CALENDAR_WRAPPER['event']['EC_NAV_LINKCURRENTMONTH'] =  "{---}";

$CALENDAR_TEMPLATE['event']['time_table'] = $CALENDAR_TEMPLATE['calendar']['time_table'];
$CALENDAR_TEMPLATE['event']['time_table_end']  = $CALENDAR_TEMPLATE['calendar']['time_table_end']; 
$CALENDAR_TEMPLATE['event']['navigation_table'] = $CALENDAR_TEMPLATE['calendar']['navigation_table'];

// EVENT LIST ------------------------------------------------------------
//$sc_style['EC_EVENTLIST_CAPTION']['pre'] = "";
//$sc_style['EC_EVENTLIST_CAPTION']['post'] = "\n";
$CALENDAR_WRAPPER['event']['EC_EVENTLIST_CAPTION'] =  "<tr><td class='fcaption' colspan='2'>{---}:<br /><br /></td></tr>";

$CALENDAR_TEMPLATE['event']['eventlist_table_start'] = "<table class='table fborder'>{EC_EVENTLIST_CAPTION}";
$CALENDAR_TEMPLATE['event']['eventlist_table_end'] = "</table>";
...
$CALENDAR_WRAPPER['event']['EC_EVENTARCHIVE_CAPTION'] =  "<tr><td colspan='2' class='fcaption'>{---}</td></tr>";

$CALENDAR_TEMPLATE['event']['archive_table_start'] = "<br /><table class='table fborder'>{EC_EVENTARCHIVE_CAPTION}";
$CALENDAR_TEMPLATE['event']['archive_table'] = "
<tr>
...
$CALENDAR_TEMPLATE['event']['archive_table_empty'] = "<tr><td colspan='2' class='forumheader3'>{EC_EVENTARCHIVE_EMPTY}</td></tr>\n";
$CALENDAR_TEMPLATE['event']['archive_table_end'] = "</table>";



// EVENT SHOW EVENT ------------------------------------------------------------
$CALENDAR_TEMPLATE['event']['event_table_start'] = "<table class='table fborder' cellspacing='0' cellpadding='0'>";
$CALENDAR_TEMPLATE['event']['event_table_end'] = "</table>";

$CALENDAR_WRAPPER['event']['EC_EVENT_HEADING_DATE'] =  "{---}";
$CALENDAR_WRAPPER['event']['EC_EVENT_DETAILS'] 			=  "<tr><td colspan='2' class='forumheader3'>{---}</td></tr>";
$CALENDAR_WRAPPER['event']['EC_EVENT_LOCATION'] 		=  "<tr><td colspan='2' class='forumheader3'><b>".EC_LAN_32."</b>{---}</td></tr>";
$CALENDAR_WRAPPER['event']['EC_EVENT_AUTHOR'] =  "<b>".EC_LAN_31."</b>{---}&nbsp;";
$CALENDAR_WRAPPER['event']['EC_EVENT_CONTACT'] 			=  "<b>".EC_LAN_33."</b> {---}&nbsp;";
$CALENDAR_WRAPPER['event']['EC_EVENT_THREAD'] 		=  "<tr><td colspan='2' class='forumheader3'><span class='smalltext'>".EC_LAN_32."</span></td></tr>";

$CALENDAR_WRAPPER['event']['EC_EVENT_CATEGORY'] =  "<b>".EC_LAN_30."</b> {---}&nbsp;";
$CALENDAR_WRAPPER['event']['EC_EVENT_DATE_START'] 			=  "{---}";
$CALENDAR_WRAPPER['event']['EC_EVENT_TIME_START'] 		=  "{---}";
$CALENDAR_WRAPPER['event']['EC_EVENT_DATE_END'] =  "{---}";
$CALENDAR_WRAPPER['event']['EC_EVENT_EVENT_DATE_TIME'] 			=  "<b>".EC_LAN_29."</b> {---}";
$CALENDAR_WRAPPER['event']['EC_IFNOT_ALLDAY'] 		=  EC_LAN_144."{---}";

$CALENDAR_TEMPLATE['event']['event_table_start'] = "<table class='table fborder event_table_start'>";
$CALENDAR_TEMPLATE['event']['event_table_end'] = "</table>";
...
$CALENDAR_TEMPLATE['event']['event_datetime'][0]  = "{EC_EVENT_DATE_START}".EC_LAN_144."{EC_EVENT_TIME_START}<b>  ".EC_LAN_69."</b> {EC_EVENT_DATE_END}{EC_IFNOT_ALLDAY=EC_EVENT_TIME_END}";
$CALENDAR_TEMPLATE['event']['event_datetime'][1]  = "{EC_EVENT_DATE_START} ".EC_LAN_84." {EC_EVENT_TIME_START}".EC_LAN_85."{EC_EVENT_TIME_END}";
$CALENDAR_TEMPLATE['event']['event_datetime'][2]  = "{EC_EVENT_DATE_START} <b>".EC_LAN_69."</b> {EC_EVENT_DATE_END}";
$CALENDAR_TEMPLATE['event']['event_datetime'][3]  = "{EC_EVENT_DATE_START}";

$CALENDAR_TEMPLATE['event']['event_table'] = "
<tr>
  <td >
...
//------------------------------------------
$CALENDAR_TEMPLATE['calendar']['calendar_start'] = "
...
$CALENDAR_TEMPLATE['calendar']['calendar_end']  = "
</tr>\n</table></div>";

// 'Empty' cells where there's not a day at all
$CALENDAR_TEMPLATE['calendar']['calendar_day_non'] = "<td style='width:14%;height:90px;'></td>";

//header row
$CALENDAR_TEMPLATE['calendar']['calendar_header_start'] = "<tr>";
$CALENDAR_TEMPLATE['calendar']['calendar_header'] = "<td class='fcaption' style='z-index: -1; background-color:#000; color:#FFF; width:90px; height:20px; text-align:center; vertical-align:middle;'>{EC_CALENDAR_CALENDAR_HEADER_DAY}</td>";
$CALENDAR_TEMPLATE['calendar']['calendar_header_end'] = "</tr>\n<tr>";


$CALENDAR_TEMPLATE['calendar']['calendar_weekswitch'] = "</tr>\n<tr>";

//today
$CALENDAR_TEMPLATE['calendar']['calendar_day_today'] = "
...
//day has events
$CALENDAR_TEMPLATE['calendar']['calendar_day_event'] = "
...
$CALENDAR_TEMPLATE['calendar']['calendar_day_empty'] = "
...
$CALENDAR_TEMPLATE['calendar']['calendar_day_end'] = "</td>";
...
$CALENDAR_TEMPLATE['calendar']['showevent'] = "<table cellspacing='0' cellpadding='0' style='width:100%;'><tr>{EC_CALENDAR_CALENDAR_RECENT_ICON}<td style='vertical-align:top; width:10px;'>{EC_SHOWEVENT_IMAGE}</td><td style='vertical-align:top; width:2%;'>{EC_SHOWEVENT_INDICAT}</td><td style='vertical-align:top;'>{EC_SHOWEVENT_HEADING}</td></tr>\n</table>";


//------------------------------------------
// Calendar menu - 'Small' calendar
//------------------------------------------
$CALENDAR_TEMPLATE['calendar_menu']['hdg_link_class'] = "class='forumlink'";			// Class, and optional style, for menu heading if its a clickable link
$CALENDAR_TEMPLATE['calendar_menu']['start'] = "<div style='text-align:center'>";
$CALENDAR_TEMPLATE['calendar_menu']['table_start'] =  "<table cellpadding='0' cellspacing='1' style='width:100%;' class='table fborder'>";	// colgroup doesn't work!

$CALENDAR_TEMPLATE['calendar_menu']['end'] = "</tr></table></div>";

// Blank cells at beginning and end
$CALENDAR_TEMPLATE['calendar_menu']['day_non'] = "<td class='forumheader3' style='width:14.28%; padding:1px; text-align:center; '>&nbsp;</td>";

//header row
$CALENDAR_TEMPLATE['calendar_menu']['header_start'] = "<tr>\n";
$CALENDAR_TEMPLATE['calendar_menu']['header_front'] = "<th class='forumheader' style='text-align:center; vertical-align:middle;'><span class='smalltext'>";
$CALENDAR_TEMPLATE['calendar_menu']['header_back'] = "</span></th>";
$CALENDAR_TEMPLATE['calendar_menu']['header_end'] = "</tr>\n<tr>";


$CALENDAR_TEMPLATE['calendar_menu']['weekswitch'] = "</tr>\n<tr>";
...
//today, no events
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['1'] = "<td class='indent' style='width:14.28%; padding:1px; text-align:center; '>";

// no events and not today
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['2'] = "<td class='forumheader3' style='width:14.28%; padding:1px; text-align:center; '>";

//day has events - same whether its today or not
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['3'] = "<td class='indent' style='width:14.28%; padding:1px; text-align:center; '>";
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['4'] = "<td class='indent' style='width:14.28%; padding:1px; text-align:center; '>";
// day has events, one which is recently added/updated
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['5'] = "<td class='indent' style='width:14.28%; padding:1px; text-align:center; '>";
$CALENDAR_TEMPLATE['calendar_menu']['day_start']['6'] = "<td class='indent' style='width:14.28%; padding:1px; text-align:center; '>";
...
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['1'] = "</td>";
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['2'] = "</td>";
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['3'] = "</td>";
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['4'] = "</td>";
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['5'] = "</td>";
$CALENDAR_TEMPLATE['calendar_menu']['day_end']['6'] = "</td>";
...
$CALENDAR_WRAPPER['next_event_menu']['EC_NEXT_EVENT_TIME'] = EC_LAN_144."{---}";
$CALENDAR_WRAPPER['next_event_menu']['EC_NEXT_EVENT_ICON'] = "<img style='clear: right; float: left; margin: 0px 3px 0px 0px; padding:1px; border: 0px;' src='{---}' alt='' />";

$CALENDAR_TEMPLATE['next_event_menu']['cal_fe_line'] = "{EC_NEXT_EVENT_RECENT_ICON}{EC_NEXT_EVENT_ICON}{EC_NEXT_EVENT_DATE}{EC_NEXT_EVENT_TIME}<br /><strong>{EC_NEXT_EVENT_TITLE}</strong>{EC_NEXT_EVENT_GAP}";
